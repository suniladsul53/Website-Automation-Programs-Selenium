...
{
    [Command(Name = "pinterest.search", Tooltip = "This command search any text on pinterest search box")]
    class PinterestSearchCommand : Command
    {
        ...
        public void Execute(Arguments arguments)
        {
            try
            {
                arguments.Search.Value = "/html/body/div[1]/div[1]/div[2]/header/div/div/div[2]/div/div/div/div[3]/div/div/div[1]/input`";
